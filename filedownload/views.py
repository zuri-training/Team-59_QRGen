...
'''
    if it is static and if it is dynamic but not pdf download,
    it will autoredirect to the static url 
    bounded to the qrcode.
    If dynamic and pdf download, it will autoredirect
